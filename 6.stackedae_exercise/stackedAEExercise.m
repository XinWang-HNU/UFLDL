...
%
%  This loads our trainin = g data from the MNIST database files.
...
[pred] = stackedAEPredict(stackedAETheta, inputSize, hiddenSizeL2, ...
                          numClasses, netconfig, testData, Bag);
