...
clear all
currentFolder = pwd;
addpath(genpath([currentFolder '\library\']))
addpath(genpath([currentFolder '\data\']))
%  Instructions
%  ------------
% 
...
linearDecoderExercise %Needs: sparseAutoencoderLinearCost
                      %Generate: STL10Features.mat
% --------------------------------------------------------------------
