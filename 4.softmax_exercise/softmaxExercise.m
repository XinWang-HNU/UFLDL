...
W1=[];
for temp=1:5
W1 =[W1 reshape((softmaxModel.optTheta(temp,:))',[sqrt(inputSize) sqrt(inputSize)])];
end
W2=[];
for temp=6:10
W2 =[W2 reshape((softmaxModel.optTheta(temp,:))',[sqrt(inputSize) sqrt(inputSize)])];
end
imwrite(mat2gray([W1;W2]),'weghts.bmp','BMP')